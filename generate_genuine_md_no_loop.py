...
def main():
    ...
    # KOP DAN ABSTRAK
    md.append("# NASKAH AKADEMIK (DATA MURNI & TANPA REPETISI)")
    ...
    out_path = r"c:\Users\msi\Documents\New folder\Nickel-Spatiotemporal-GTWR-Leontief\Tesis_Riil_Nikel_GTWR_TanpaRepetisi.md"
